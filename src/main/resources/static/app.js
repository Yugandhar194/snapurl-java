...
const sizeSlider=$("#imageSize"),sizeValue=$("#imageSizeValue");if(sizeSlider){sizeSlider.oninput=()=>sizeValue.textContent=Number(sizeSlider.value).toLocaleString()+" KB"}
